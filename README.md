...
| Tag | State |
|---|---|
| [`v1.2`](../../tree/v1.2) | Current. Cap tab-and-slot joints are generated by default: every supported clamp and pin-carrier cap receives two separated locating tabs without hand-authoring, and the 10 mm material-width audit now also runs during the concept preview. 133 tests pass. |
