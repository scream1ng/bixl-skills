...
- Cross-support tall/slender uprights with perpendicular members. Model actual complementary cross-lap slots or tab-and-slot connections between the members and the supported cap, plus the required base tabs. Adjacent butt faces do not constitute a dry-fit interlock.
